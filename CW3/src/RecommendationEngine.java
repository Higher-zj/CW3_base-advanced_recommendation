...
public class RecommendationEngine {
    ...
    public String getStrategyDescription(String strategy) {
        switch (strategy) {
            case "genre": return "Recommends movies in your favorite genres (based on viewing patterns), excluding movies you've watched or added to watchlist";
            case "rating": return "Recommends highest rated movies excluding those you've watched or added to watchlist";
            case "year": return "Recommends the most recent movies excluding those you've watched or added to watchlist";
        }
